...
export default function EmployeeBenefitsCTA() {
  ...
  return (
    <section
      ref={ref}
      id="employee-benefits-cta"
      className="relative py-28 md:py-36 bg-navy-950 overflow-hidden"
      aria-label="Employee benefits CTA — Partner with Turboserv"
    >
      ...
      >
        ...
        <motion.h2
          ...
          custom={1}
        >
          Elevate Your Corporate Benefits{" "}
          <span className="text-red-500">Programme Today.</span>
        </motion.h2>
        ...
        <motion.p
          ...
          custom={2}
        >
          Whether you require Statutory Group Life compliance, comprehensive HMO healthcare coverage, or pension-linked riders, Turboserv delivers tailored employee benefits brokerage.
        </motion.p>
        ...
        >
          ...
          <a
            href="/contact"
            id="employee-benefits-cta-proposal-btn"
            ...
            aria-label="Request a benefits proposal"
          >
            <span
            ...
            <span className="relative z-10">
              Request a Benefits Audit &amp; Proposal
            </span>
          ...
          <a
            ...
            id="employee-benefits-cta-speak-broker-btn"
        ...
        >
          {[
            "PenCom Audit Compliant",
            "Broad HMO Hospital Networks",
            "Fast Death-in-Service Payouts",
