...
export default function EmployeeBenefitsHero() {
  return (
    <section
      className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-16"
      id="employee-benefits-hero"
      aria-label="Corporate Employee Benefits Solutions hero"
    >
      {/* White base */}
      ...
      >
        ...
        >
          ...
          <span className="text-red-600 italic">Benefits</span>
          <br />
          &amp; Pension Solutions
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Empower your talent and maintain strict statutory compliance. Turboserv structures comprehensive employee benefits programmes — encompassing Statutory Group Life, Pension-related Insurance, Medical HMO plans, and Executive Gratuity schemes — that maximize employee retention while optimizing corporate premium spend.
        </motion.p>
        ...
        >
          <a
            href="#employee-benefits-solutions"
            id="employee-benefits-hero-explore-btn"
            ...
            aria-label="Explore employee benefits solutions"
          >
            <span>Explore Benefits Solutions</span>
          ...
          <a
            href="/contact"
            id="employee-benefits-hero-contact-btn"
