...
export default function MotorCTA() {
  ...
  return (
    <section
      ...
      aria-label="Motor insurance CTA — Partner with Turboserv"
    >
      ...
      >
        ...
        <motion.h2
          ...
          custom={1}
        >
          Secure Your Corporate Fleet{" "}
          <span className="text-red-500">With Expert Brokerage.</span>
        </motion.h2>
        ...
        <motion.p
          ...
          custom={2}
        >
          Whether you require Comprehensive Motor policies for executive cars, Third Party compliance for utility vehicles, or complete fleet risk pooling, Turboserv delivers tailored motor brokerage.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            aria-label="Request a fleet quotation"
          >
            <span
            ...
            <span className="relative z-10">
              Request a Fleet Risk Quotation
            </span>
          ...
          <a
            ...
            aria-label="Speak to a motor insurance specialist"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
            ...
            <span>Speak to a Fleet Specialist</span>
          </a>
        </motion.div>
        ...
        >
          {[
            "Instant NIID Registration",
            "Certified OEM Workshop Network",
            "24/7 Roadside Assistance Advocacy",
            "Zero-Friction Fleet Additions",
          ].map((item) => (
