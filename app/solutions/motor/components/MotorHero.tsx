...
export default function MotorHero() {
  return (
    <section
      ...
      id="motor-hero"
      aria-label="Corporate Motor & Fleet Insurance Solutions hero"
    >
      {/* White base */}
      ...
      >
        ...
        <motion.span
          ...
          custom={0}
        >
          Insurance Solutions — Motor &amp; Fleet
        </motion.span>
        ...
        >
          Corporate Motor &amp;{" "}
          <span className="text-red-600 italic">Fleet Insurance</span>
          <br />
          Solutions
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Keep your executive, utility, and commercial logistics fleets moving safely. Turboserv structures comprehensive motor insurance policies, corporate fleet risk management, and rapid repairs advocacy that protect your physical assets and eliminate vehicle downtime.
        </motion.p>
        ...
        >
          <a
            href="#motor-solutions"
            id="motor-hero-explore-btn"
            ...
            aria-label="Explore motor insurance solutions"
          >
            <span>Explore Motor Solutions</span>
