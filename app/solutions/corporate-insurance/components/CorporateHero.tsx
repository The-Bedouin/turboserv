...
export default function CorporateHero() {
  return (
    <section
      ...
      id="corporate-hero"
      aria-label="Corporate Insurance Solutions hero"
    >
      {/* White base */}
      ...
      >
        ...
        <motion.span
          ...
          custom={0}
        >
          Insurance Solutions — Corporate &amp; Enterprise
        </motion.span>
        ...
        >
          ...
          <span className="text-red-600 italic">Insurance</span>
          <br />
          &amp; Risk Protection
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Protecting physical assets, complex engineering projects, global trade cargo, energy installations, and corporate liabilities across West Africa. Turboserv structures 11 institutional covers designed to safeguard balance sheet resilience and enterprise continuity.
        </motion.p>
        ...
        >
          <a
            ...
            aria-label="Explore corporate insurance solutions"
          >
            <span>Explore 11 Corporate Solutions</span>
