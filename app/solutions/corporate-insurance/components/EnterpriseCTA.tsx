...
export default function EnterpriseCTA() {
  ...
  return (
    <section
      ...
      aria-label="Enterprise CTA — Secure your corporate future"
    >
      ...
      {/* Decorative lines */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-red-600/40 to-transparent" aria-hidden="true" />
      ...
      >
        ...
        >
          Secure Your{" "}
          <span className="text-red-500">Corporate Future.</span>
        </motion.h2>
        ...
        <motion.p
          ...
          custom={2}
        >
          Every day without a professionally structured risk programme is a day your enterprise operates with unquantified financial exposure. Take the first step — our senior brokers will conduct a no-obligation risk audit and deliver a gap analysis within 5 working days.
        </motion.p>
        ...
        >
          ...
          <a
            href="/contact"
            id="enterprise-cta-risk-audit-btn"
            ...
            aria-label="Request a comprehensive risk audit"
          >
            <span className="absolute inset-0 rounded-full bg-gradient-to-r from-red-600 to-red-500 transition-all duration-500 group-hover:from-red-500 group-hover:to-red-600" aria-hidden="true" />
            {/* Shimmer */}
            <span
              ...
              aria-hidden="true"
            />
            <span className="relative z-10">Request a Comprehensive Risk Audit</span>
          ...
          <a
            ...
            id="enterprise-cta-speak-broker-btn"
            ...
            aria-label="Speak to a lead broker"
          >
            <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-red-400" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span>Speak to a Lead Broker</span>
          </a>
        </motion.div>
