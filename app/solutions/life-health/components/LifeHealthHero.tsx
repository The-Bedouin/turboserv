  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Protecting Your{" "}
          <span className="text-red-600 italic">Greatest Asset</span>
          <br />
          — Your People
        </motion.h1>
        ...
        <motion.p
          ...
          custom={2}
        >
          Your workforce is the engine of enterprise value. Turboserv structures
          corporate life, health, and accident programmes that safeguard employee
          wellbeing, strengthen your talent proposition, and ensure that a single
          medical emergency or loss event never destabilises the people — or the
          financial architecture — behind your business.
        </motion.p>
        ...
        >
          <a
            href="#life-health-solutions"
            id="life-health-hero-explore-btn"
            ...
            aria-label="Explore life and health solutions"
          >
          ...
          <a
            href="/contact"
            id="life-health-hero-contact-btn"
