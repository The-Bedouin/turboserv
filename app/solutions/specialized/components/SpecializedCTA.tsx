...
export default function SpecializedCTA() {
  ...
  return (
    <section
      ...
      aria-label="Specialized solutions CTA — Partner with Turboserv"
    >
      ...
      >
        ...
        <motion.p
          ...
          custom={2}
        >
          Whether you need SME microinsurance, valet liability cover, debt indemnity, or dedicated technical claims representation, Turboserv delivers tailored advisory and robust policy placement.
        </motion.p>
        ...
        >
          ...
          <a
            ...
            aria-label="Request a specialized risk audit"
          >
            <span
            ...
            <span className="relative z-10">
              Request a Specialized Risk Consultation
            </span>
          ...
          <a
            ...
            id="specialized-cta-speak-broker-btn"
